...
const CreatePoint = () => {
    ...
    useEffect(() => {
        ...
        axios.get<IBGECITYRespose[]>(`https://servicodados.ibge.gov.br/api/v1/localidades/estados/${selectedUf}/municipios`)
             .then(response => {
    ...
    async function habdleSubmit(event: FormEvent) {
